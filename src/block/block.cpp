...
void RenderBlock::SetUpFaces(glm::vec3 position, bool* facesNeeded)
{
    ...
    {
        m_vertices.push_back(Vertex(glm::vec3(0.5, 0.5, -0.5) + position, { 0, 0 }));
        m_vertices.push_back(Vertex(glm::vec3(-0.5, 0.5, -0.5) + position, { 0, 1 }));
        m_vertices.push_back(Vertex(glm::vec3(-0.5, 0.5, 0.5) + position, { 1, 1 }));
        m_vertices.push_back(Vertex(glm::vec3(0.5, 0.5, 0.5) + position, { 1, 0 }));
        m_size += 4;
    }
